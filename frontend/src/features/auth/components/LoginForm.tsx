...
export function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-500 via-orange-400 to-yellow-500 p-4">
      {/* Animated Background */}
      ...
      >
        <div className="bg-card rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-red-500 to-orange-500 p-8 text-center">
            ...
            >
              <svg viewBox="0 0 100 100" className="w-12 h-12 text-red-500">
            ...
            <h1 className="text-2xl font-bold text-white">Centro Pokémon</h1>
            <p className="text-white/80 text-sm mt-1">Faça login para continuar</p>
          </div>
